      ...
      preguntas: [
        {
          ...
          texto:
            '¿Cuál es el principal objetivo de la gestión de reservas hoteleras?',
          ...
          opciones: [
            {
              ...
              texto: 'Organizar únicamente el servicio de habitaciones.',
...

            {
              ...
              texto: 'Administrar el restaurante.',
...

            {
              ...
              texto:
                'Controlar la ocupación y optimizar los ingresos del establecimiento.',
